...
await publish(cfg.channels['order-management'],'**Vintage／Single 注文登録**','**Vintage／Single 注文登録**\n下のボタンからSingle / Vintage専用の受注画面を開きます。注文・顧客は既存のTCG_ANIMACとは別管理です。\n入力済＝受注登録完了／入金済＝入金確認完了。\n未完了注文のあるチケット、または顧客と未紐づけのチケットは自動移動しません。/confirm で既存顧客を選ぶと紐づけられます。',[{type:1,components:[{type:2,style:5,label:'Vintage / Single 注文登録',url:'https://animac.intl.shipord.jp/orders/new?ch=sv'}]}]);
